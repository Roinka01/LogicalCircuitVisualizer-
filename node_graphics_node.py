...
class QDMGraphicsNode(QGraphicsItem):
    ...
    def paint(self, painter, QStyleOptionGraphicsItem, widget=None):
        ...
        # myPolygon = QPolygonF()
        # myPolygon.append(QPointF(0, self.title_height))
        # myPolygon.append(QPointF(self.width, self.title_height))
        # myPolygon.append(QPointF(0, self.height+self.title_height))
        # myPolygon.append(QPointF(self.width, self.height+self.title_height))
        # path_content.addPolygon(myPolygon)
        # path_content.moveTo(0,self.height+self.title_height)
        # path_content.lineTo(self.width,self.height+self.title_height )
